              ...
              {typeof analysis.business_model === 'object' && analysis.business_model.revenue_streams && (
                <div className="mt-4">
                  ...
                  <div className="space-y-2">
                    {analysis.business_model.revenue_streams.map((stream: string, index: number) => (
        ...
        <Card>
          ...
          <CardContent>
            <div className="grid md:grid-cols-3 gap-6">
              ...
              {analysis.competitive_position.strengths && (
                <div>
                  <p className="text-sm text-gray-600 mb-2 font-semibold">Strengths</p>
                  <div className="space-y-1">
                    {analysis.competitive_position.strengths.map((strength: string, index: number) => (
                      <div key={index} className="flex items-center gap-2">
              ...
              {analysis.competitive_position.weaknesses && (
                <div>
                  <p className="text-sm text-gray-600 mb-2 font-semibold">Areas for Improvement</p>
                  <div className="space-y-1">
                    {analysis.competitive_position.weaknesses.map((weakness: string, index: number) => (
                      <div key={index} className="flex items-center gap-2">
