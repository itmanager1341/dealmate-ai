...
Generated by DealMate AI`;
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Financial Metrics - Dynamic Table */}
      {analysis.financial_metrics && (
        <Card>
          ...
          <CardContent>
            <DynamicTableRenderer data={analysis.financial_metrics} />
          </CardContent>
        </Card>
      )}

      {/* Business Model - Dynamic Table */}
      {analysis.business_model && (
        <Card>
          ...
          <CardContent>
            <DynamicTableRenderer data={analysis.business_model} />
          </CardContent>
        </Card>
      )}
      ...
      {/* Competitive Position - Dynamic Table */}
      {analysis.competitive_position && (
        <Card>
          ...
          <CardContent>
            <DynamicTableRenderer data={analysis.competitive_position} />
          </CardContent>
        </Card>
      )}
      ...
      {analysis.recommendation && (
        <Card>
          ...
          <CardContent>
            <DynamicTableRenderer data={analysis.recommendation} />
          </CardContent>
        </Card>
      )}
